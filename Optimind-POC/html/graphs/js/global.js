...
//      remove eBecause when Kim graph does not open  $(section).append('<a class="rollover" />')
(function ($) {
...
$(document).ready(function () {
    ...
    */
    $(".widget.has-details > section").each(function () {
        var section = this;
        //      remov eBecause when Kim graph does not open  $(section).append('<a class="rollover" />')
        $(section)
            .find('.rollover')
